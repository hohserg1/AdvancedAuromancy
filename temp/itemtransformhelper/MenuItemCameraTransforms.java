...
public class MenuItemCameraTransforms
{
  ...
  {
    void keyPressed(MenuKeyHandler.ArrowKeys whichKey, boolean ctrl)
    {
      ...
      switch (whichKey) {
        ...
        case RIGHT:
        case LEFT: {
          alterField(whichKey == MenuKeyHandler.ArrowKeys.RIGHT, ctrl);
          break;
        }
        case NONE:
      }
  ...
  private void alterField(boolean increase, boolean ctrl)
  {
    ...
    final float ROTATION_INCREMENT = ctrl?1F:2F;
    final float TRANSLATION_INCREMENT = (ctrl?0.1F:0.25F) * 0.0625F; // 1/4 of a block, with multiplier from ItemTransformVec3f::deserialize0()
                                   ...
                                   )
  {
    ...
    if (savedModel != null) {  // IPerspectiveAware just have identity matrix for getItemCameraTransforms
  ...
  public static class MenuKeyHandler
  {
    ...
    public void clientTick(TickEvent.ClientTickEvent event)
    {
      ...
      keyPressCallback.keyPressed(keyPressed,ctrl);
    }
